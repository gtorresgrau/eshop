...
//       <Link href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900" title="CentralCam Logo">
//           <Image className="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo" loading='lazy' title="CentralCam Logo" />
//           CentralCam    
//       </Link>
