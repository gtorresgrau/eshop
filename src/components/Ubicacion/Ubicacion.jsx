    ...
    return (
        <section id="ubicacion" className="mx-auto max-w-2xl py-10 px-4 lg:max-w-7xl lg:px-8">
            <article className='flex flex-col items-center justify-center py-2 m-2 w-full'>
                <h2 className="mb-4 text-3xl md:text-4xl text-center md:text-start tracking-tight font-extrabold text-text-primary-title uppercase">¿Dónde nos encontras?</h2>
                <iframe
