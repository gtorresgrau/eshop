          ...
          {items.map((item, index) => (
            <div key={index} className="mb-4 border-b pb-2 sm:grid sm:grid-cols-5 sm:gap-2">
                <div className="mt-2 sm:mt-0 sm:col-span-5 flex justify-end">
                    <Button onClick={() => handleRemoveItem(index)} className="text-red-600 bg-inherit rounded-full px-1 text-sm font-extrabold hover:scale-110 hover:ring-1 hover:ring-red-500 hover:bg-red-500 hover:text-white">X</Button>
                </div>
