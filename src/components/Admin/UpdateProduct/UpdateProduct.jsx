...
export default function UpdateProduct({
 ...
 // esto es para incorporar el spinner dentro del sweetAlert
  ...
  return (
    <div>
      <div id="updateProductModal" tabIndex="-1" aria-hidden="editar producto" className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-10 overflow-hidden ${
          isOpenModal ? "" : "hidden" }`}>
          ...
          <div className="relative p-4 bg-white shadow-sm">
            <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
              ...
              <button type="button" onClick={handleToggleModal} // Utilizamos la función para manejar el cierre del modal
                ...
                <svg aria-hidden="boton para editar" className="w-5 h-5" width={20} height={20} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" >
