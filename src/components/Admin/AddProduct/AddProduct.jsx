...
export default function AddProduct({
  ...
  const [producto, setProducto] = useState({
    _id: '',
    n_producto: '',        // si no lo elegís acá, lo genera el backend
    cod_producto: '',      // idem: que lo genere el backend
    marca: '',
    categoria: '',
    nombre: '',
    modelo: '',
...
const hasImageChanges = () => {
    ...
    const handleChangeInput = (e) => {
      ...
      setProducto(prev => {
        ...
        next.titulo_de_producto = `${next.nombre} ${next.marca}`.trim();
        return next;
      });
    };
              ...
              <form id='formAddProduct' onSubmit={submitAddProduct}>
                ...
                {/* Nombre */}
                  ...
                  <div className='flex gap-2 mb-2'>
                    ...
                    <input onChange={handleChangeInput} type="checkbox" name="stock" id="StockAdd" checked={producto.stock}/>
                    <label htmlFor="StockAdd" className="block  text-sm font-medium text-gray-900" >Sin Stock</label>
                  </div>
                </div>
