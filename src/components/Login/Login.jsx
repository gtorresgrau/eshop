                        ...
                        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                            <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    <Link href="/" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 justify-center" title="ESHOP Logo">
                                        <Image className="mr-2 h-auto" src="/logos/logo.webp" width={150} height={150} alt="ESHOP logo" title="ESHOP Logo" loading="lazy" />
                                    </Link>
